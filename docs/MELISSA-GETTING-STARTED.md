...
Once Victor adds you as a collaborator:
...
## Step 3: Log Into the Content Manager
...
| **Statistics** | Impact numbers on the homepage |
| **People** | Staff and Board member profiles |
| **About Page** | History timeline, partners |
| **Events** | Featured event, sponsorship levels |
...
| Resource | Link |
|----------|------|
| **Content Manager** | https://rfy.thewicksproject.org/admin/ |
| **Live Site** | https://rfy.thewicksproject.org |
| **GitHub Repo** | https://github.com/vwieczorek/rfy-website |
